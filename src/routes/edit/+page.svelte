...
<svelte:head>
    <title>ArkIDE - Edit {projectName}</title>
    <meta name="title"                   content="ArkIDE - Edit" />
    <meta property="og:title"            content="ArkIDE - Edit" />
    <meta property="twitter:title"       content="ArkIDE - Edit">
            ...
            >
                <div style="width:50%;">
                    ...
                    <input
                        ...
                        type="file"
                        class="hidden-picker"
                        accept=".pmp,.pm,.sb3,.sb2,.sb,.goobert,.arkide"
