...
<svelte:head>
    <title>ArkIDE - Developer Post</title>
    <meta name="title"                   content="ArkIDE - Developer Post" />
    <meta property="og:title"            content="ArkIDE - Developer Post" />
    <meta property="twitter:title"       content="ArkIDE - Developer Post" />
</svelte:head>
